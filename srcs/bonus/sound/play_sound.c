...
static void	play_mj_sound_positioned(t_sound_mini *sound,
		t_main_struct *main_struct)
{
	if (sound->no_audio_device)
		return ;
	ma_sound_set_position(&sound->mj_sound, main_struct->mj->x,
		main_struct->mj->y, 0.0f);
	ma_engine_listener_set_position(&sound->engine, 0, main_struct->player->x,
		main_struct->player->y, 0.0f);
